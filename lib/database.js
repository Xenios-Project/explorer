...
module.exports = {
    ...
    update_last_price: function(cb) {

        const fetch = require('node-fetch');
        console.log('starteed get last price')
        let url = "https://xeniosmarkets.com/api/public?command=returnTicker";
        ...
        fetch(url, settings)
            ...
            .then((json) => {
                ...
                Stats.updateOne({ coin: settings.coin }, {
                    last_price: parseFloat(json['XNC_EURX']['last']),
                }, function() {
                    console.log(parseFloat(json['XNC_EURX']['last']));
